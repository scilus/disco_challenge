...
#
# Step 1 : Denoise DWI
# Step 2 : Compute FA map
# Step 3 : Compute tissue masks
# Step 4 : Compute frf
# Step 5 : Compute fodf
# Step 6 : either	- Compute local tracking (use 'local')
#			- Compute pft (use 'pft')
# Step 7 : Run commit
# Step 8 : Decompose connectivity
# Step 9 : Compute connectivity
# Step 10 : Compute correlation
# Step 11 : Compute binary correlation
